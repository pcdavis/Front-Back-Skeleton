...
npx creat-react-app projectName
DON'T FORGET to CD into the FUCKING folder! (or just type create-react-app . which will install it in existing folder but the folder name will be the project name)
